...
<script type="application/ld+json">{json.dumps({"@context":"https://schema.org","@type":"Organization","name":"GitDealFlow","url":BASE,"description":"GitDealFlow tracks commit velocity, contributor growth, and repository expansion across ~400 startup GitHub orgs in 25 sectors. Surfaces breakout engineering teams 3–6 weeks before fundraise announcements."})}</script>
<script>
...
<header style="margin-bottom:40px"><a href="{BASE}" class="gdf-wordmark">GitDealFlow</a><nav aria-label="Primary navigation" class="gdf-topnav"><a href="{BASE}/pricing">Pricing</a><a href="{SIGNALS}">Live signals</a></nav></header>
<main>
...
<p style="font-size:1.1em;color:#555;margin-bottom:2em">{tagline.capitalize()} — tracked at the GitHub-org level across ~400 startups.</p>
