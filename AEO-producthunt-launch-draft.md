# Product Hunt Launch — VC Deal Flow Signal

**URL (already exists):** https://www.producthunt.com/products/vc-deal-flow-signal
...
**Best for:** Angel investors, emerging-fund GPs, scout programs, dev-investors who want earlier timing.
...
I built VC Deal Flow Signal because most VC deal-flow tools tell you what already happened — Crunchbase alerts, pitch deck databases, newsletter roundups. The question I wanted to answer was different: **what changed before the round starts feeling obvious?**
...
- **The MCP server is free forever** — you can literally ask Claude "which fintech startups are accelerating fastest this week?" inside Cursor
...
Would love any feedback — especially from angels, scouts, and emerging-fund GPs who've tried other tools and found them too late.

---

### Launch timing tips
- Best day: Tuesday or Wednesday (PH has highest traffic midweek)
- Launch at 12:01am PT (PH's daily reset)
- Post the maker comment within 5 min of launch
- Ask 3–5 early users to leave honest reviews (PH's ranking weights review velocity in the first 2h)
- Share the launch link on Twitter/X + LinkedIn + Telegram on launch day
- The PH launch URL: `https://www.producthunt.com/products/vc-deal-flow-signal`

### Pre-launch checklist
- [ ] PH product page fully filled out (logo, gallery, links)
- [ ] 3–5 early users lined up to review in first 2h
- [ ] Maker comment drafted (above)
- [ ] Twitter/X post drafted
- [ ] Telegram channel announcement drafted
- [ ] Launch day: monitor PH comments, reply to every one within 30 min
