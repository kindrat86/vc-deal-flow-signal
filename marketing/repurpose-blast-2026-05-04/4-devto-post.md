...
Every Monday at 09:00 EEST a Vercel cron pulls the GitHub REST and GraphQL APIs for 100 tracked startup orgs across 19 sectors. For each org I compute, over a rolling 14-day window:
...
Every number is reproducible from public GitHub. The CSV for this week's full dataset (100 startups across 19 sectors) is at `signals.gitdealflow.com/data-sources`. Methodology is at `signals.gitdealflow.com/methodology`.
