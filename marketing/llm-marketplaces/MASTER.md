...
| 16 | Smithery submission package | ✅ published and live | [distribution/smithery-submission/SUBMISSION.md](../../distribution/smithery-submission/SUBMISSION.md). Live verification on 2026-08-21 found two public listings: `kindrat86/vc-deal-flow-signal` (98/100) and `kindrat86/mcp-deal-flow-signal` (87/100). |
...
| 25 | npm package republished v1.5.3 (README-only patch) | ✅ LIVE on npm + MCP Registry 2026-05-03 | [npmjs.com/.../v/1.5.3](https://www.npmjs.com/package/@gitdealflow/mcp-signal/v/1.5.3) + [registry.modelcontextprotocol.io](https://registry.modelcontextprotocol.io/v0/servers?search=vc-deal-flow) (8 versions registered, 1.5.3 latest). Tarball SHA `6a98057a...`. JWT refreshed via interactive user login at 19:18 EEST; `mcp-publisher publish` ran from `mcp-server/` and succeeded immediately. |
