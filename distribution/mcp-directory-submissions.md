...
- [x] mcp.so - submitted via GitHub issue https://github.com/chatmcp/mcpso/issues/2081
...
2. **smithery.ai** - https://smithery.ai/new
   - Requires Streamable HTTP transport (our server is stdio-only)
   - SKIP unless we add HTTP transport later
