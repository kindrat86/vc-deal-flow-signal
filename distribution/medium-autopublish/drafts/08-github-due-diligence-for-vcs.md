...
**Subtitle:** Three checks, three avoidable disasters, and the cheap technical screen I should've run before I let myself open the checkbook.

**Tags:** Venture Capital, Due Diligence, GitHub, Angel Investing, Startups

**Canonical URL:** https://signals.gitdealflow.com/blog/github-due-diligence-for-vcs
...
*Originally published at [signals.gitdealflow.com](https://signals.gitdealflow.com/blog/github-due-diligence-for-vcs). The weekly Signal Report is free — no paywall, no account.*
