...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes. The five tier-zero tools — get_trending_startups, search_startups_by_sector, get_startup_signal, get_signals_summary, get_methodology — are free with no signup, no rate limit, no telemetry. New paid tools may ship later, but the original five stay free.",
  },
];
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-gray-300 mb-4">
            These five tools are tier-zero — free, no signup, no rate limit on
          ...
          <p className="text-xs text-gray-500 mt-3">
            ...
            ·{" "}
            <a
              href="https://smithery.ai/server/kindrat86/vc-deal-flow-signal"
              className="hover:text-gray-300"
              rel="noopener"
            >
              Smithery (verified, 98/100)
            </a>
          </p>
        </section>
