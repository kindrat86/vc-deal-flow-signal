...
<p style="color:#64748b;font-size:14px;">P.P.S. If you want the methodology run for you on a 250+ org universe every Monday, the Dashboard locks in <a href="${SITE_URL}/pricing#dashboard-beta" style="color:#0ea5e9;">€49/mo</a>. The methodology is in the book; the Dashboard is the methodology executed.</p>
</div>
