...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description:
        "MCP server exposing six read-only tools over engineering-acceleration signals for 985+ venture-backed startups across 20 sectors. Streamable HTTP, no auth, public dataset.",
