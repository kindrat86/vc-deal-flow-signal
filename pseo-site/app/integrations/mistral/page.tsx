...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description:
        "MCP server exposing six read-only tools over engineering-acceleration signals for 369 venture-backed startups across 15 sectors. Streamable HTTP, no auth, public dataset.",
