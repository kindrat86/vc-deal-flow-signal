...
const FAQ = [
  ...
  },
  {
    ...
    a: "Yes. If you upgrade to Dashboard (€49/mo founding rate) within 14 days of the First Look purchase, the €7 is credited. If you don't, the deep dive is yours regardless.",
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        >
          ...
          <p className="text-gray-300 text-base leading-relaxed">
            ...
            hours. €7 credited toward Dashboard (€49/mo founding rate) if you
