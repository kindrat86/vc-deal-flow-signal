...
const DESCRIPTION =
  "Wire GitDealFlow into a CrewAI scout / analyst / skeptic crew. Three Python agents share live engineering-acceleration signals across 140 venture-backed startups. Free A2A endpoint, no auth, no LLM lock-in.";
