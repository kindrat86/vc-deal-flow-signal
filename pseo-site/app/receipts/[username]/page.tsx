...
export default async function ReceiptsResultPage({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="mb-10 rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900/80 to-slate-950 p-8 sm:p-10">
        <div className="flex flex-col sm:flex-row items-start sm:items-end gap-6 mb-6">
          <div>
            ...
            <p className={`text-7xl sm:text-8xl font-bold leading-none ${RANK_COLOR[result.rank]}`}>
              {result.score}
            </p>
          </div>
          <div className="pb-2">
            <p className={`text-2xl font-bold uppercase tracking-widest ${RANK_COLOR[result.rank]}`}>
