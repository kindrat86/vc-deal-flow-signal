    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="rounded-lg border border-slate-800 bg-slate-900 p-6">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">Drop the live quick ratio calculator into a newsletter, blog, or portal. The snippet ships a visible source credit linking back here.</p>
          <EmbedThisCard embedPath="/embed/tools/quick-ratio-calculator" sourcePath="/tools/quick-ratio-calculator" label="Quick Ratio Calculator" height={500} />
        </div>
      </div>
      </div>
    </>
