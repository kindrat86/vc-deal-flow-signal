      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "The full panel refreshes every Monday morning. The pipeline pulls the latest 14-day GitHub activity for approximately 400+ startup organizations, normalizes for bot accounts and trivial commits, computes acceleration metrics, classifies signal patterns, and republishes the sector rankings, the API endpoints, the dashboard, the dataset mirrors on Zenodo and Kaggle, and the weekly Signal Report email, all in the same publishing window.",
            },
          },
          {
            "@type": "Question",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <PlainEnglishNote title="What the numbers mean" className="mb-12">
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              <strong className="text-gray-200">400+ organisations scanned every week</strong>{" "}
the full universe of venture-backed GitHub orgs we look at. This
              is the haystack, not the picks.
            </li>
            <li>
              <strong className="text-gray-200">400+ ranked and surfaced each week</strong>{" "}
...
the historical panel behind the published research (SSRN, n=219),
          ...
          <p>
            ...
            different layers. You never sift the 400+ yourself, we do, and hand
            you the shortlist.
          </p>
        </PlainEnglishNote>
