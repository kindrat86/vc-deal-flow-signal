...
const DESCRIPTION =
  "Drop GitDealFlow signals into a LangChain agent in 20 lines of Python. Live commit-velocity data on 140 venture-backed startups across 15 sectors. Free A2A endpoint, no auth. Works with ReAct, LangGraph, and langchain-mcp-adapters.";
