...
export const metadata: Metadata = {
  ...
  description:
    "A single-startup editorial each Monday. One company, one signal, one story – drawn from our ranking of 4,200+ startup GitHub orgs by engineering acceleration. Free, non-gated, citation-encouraged.",
  alternates: {
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-gray-400 text-base leading-relaxed mb-4">
          ...
          engineering-acceleration mover across our 4,200-org tracking set. One
