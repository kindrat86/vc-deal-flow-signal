...
const DESCRIPTION =
  "Drop GitDealFlow signals into a Mastra agent inside your Next.js or Hono codebase. First-class MCP via @gitdealflow/mcp-signal, edge-safe A2A fallback, Zod-validated tools. 140 startups, refreshed weekly.";
