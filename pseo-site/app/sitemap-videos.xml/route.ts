...
${tags}
  ...
  // YouTube mirror URLs (youtube.com/watch?v=...) were removed from the
  // sitemap — Google rejects cross-domain <loc> URLs with a sitemap error.
  // Each video is already fully represented by its /watch/[slug] page above,
  // which carries the youtube-nocookie embed as player_loc. AI engines
  // that index by YouTube URL can join on player_loc instead.
