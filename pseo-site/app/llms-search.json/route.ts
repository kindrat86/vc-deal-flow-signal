...
export async function GET(request: Request) {
  ...
  const staticPages: Array<Omit<SearchEntry, "lastModified">> = [
    ...
    { url: `${BASE_URL}/teardown`, title: "Tweet Teardown", summary: "€1 buyer-threshold breaker — name one startup, get a tweet-length GitHub-momentum teardown in 24h.", contentType: "page", tags: ["teardown", "paid"] },
