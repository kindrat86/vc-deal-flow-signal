...
const standaloneFaqs: FAQEntry[] = [
  ...
  },
  {
    ...
    answer:
      "VC Deal Flow Signal offers a free Signal Digest with 5 breakout startups delivered monthly. The Dashboard beta is EUR 9.97/month and gives access to 50+ ranked startups across all 20 sectors with filtering by stage, geography, and signal type. There is no annual commitment required.",
    source: "Pricing",
