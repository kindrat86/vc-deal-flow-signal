  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <AgentSummary
          tldr="VC Deal Flow Signal (GitDealFlow) has seven pricing tiers: a free weekly Signal Digest with five ranked startups, a €1 one-time Tweet Teardown (tweet-length GitHub-momentum read on one startup the buyer names, buyer-threshold breaker between Free and €7), a €7 one-time First Look Pass for a sector deep dive, a €49/mo Dashboard Beta covering 400+ startups across 15 sectors, a €197/mo Insider Circle adding private Telegram + JSON/CSV API, a €497/mo Sharp Tier for active funds with quarterly review calls + custom watchlists + white-labeled API + methodology source code (application-gated, capped at 8 funds in 2026), and a €1,997 one-time Custom Sector Sweep written report. A founding-member rate (€9.97/mo Dashboard, €97/mo Insider) closed 2026-06-30 and applies only to subscribers who joined before that date. The free MCP server (five read-only tools) is bundled with every tier including the free one and will never be gated. Every paid tier ships with a 30-day Signal-or-It's-Free guarantee."
            ...
            {[
              {
                ...
                detail:
                  "400+ venture-backed startups ranked by 14-day commit-velocity acceleration, refreshed every Monday at 06:00 UTC. Filter by sector, stage, geography.",
                value: "€348/yr",
              },
              {
