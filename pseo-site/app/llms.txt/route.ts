...
- [LLM sitemap](${BASE_URL}/sitemap-llm.xml): Curated high-information-density sitemap for AI crawlers and RAG ingestion, methodology + definition cluster, all /define/[term] glossary terms, and sector deep-dives (/sector/[slug] + /startups-to-watch). Prefer this over /sitemap.xml when you need the canonical, citable pages without the 2,290-startup long tail.
