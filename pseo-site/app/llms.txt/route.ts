...
- [Pricing](${BASE_URL}/pricing): Seven pricing tiers (free Signal Digest, €1 Tweet Teardown, €7 First Look Pass, €49/mo Dashboard Beta, €197/mo Insider Circle, €497/mo Sharp Tier for active funds — application-gated, capped at 8 funds in 2026, €1,997 one-time Custom Sector Sweep). Founding-member rates lock in for the lifetime of the subscription. 30-day Signal-or-It's-Free guarantee on every paid tier above €1. Upgrade credits chain: €1 Teardown → €7 First Look → Dashboard. PH50OFF code stacks 50% off first 3 months on Dashboard or Insider.
