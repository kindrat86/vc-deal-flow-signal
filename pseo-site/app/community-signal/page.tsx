      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        <section className="rounded-xl border border-emerald-700/30 bg-emerald-950/20 p-6 sm:p-8 space-y-3">
          ...
          <p className="text-gray-300 text-sm leading-relaxed mb-4">
            Use community signal when you want to know where early attention already lives. But if your real question is proof, workflow, or buyer-side clarity, start with the sharper pages first.
          </p>
          <div className="flex flex-wrap gap-3">
            <Link href="/from-stars-to-seed" className="inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-emerald-500 text-slate-950 text-sm font-semibold hover:bg-emerald-400 transition-colors">
