...
const DESCRIPTION =
  "Build a Letta agent that remembers every startup it has scouted. Wire GitDealFlow's A2A endpoint as a tool, get persistent watchlist memory across sessions. Five skills, 140 startups, weekly refresh, no auth.";
