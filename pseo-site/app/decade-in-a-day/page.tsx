...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    content:
      "Eight objects, each with a standalone value, totalling €1,728/yr. The buyer's brain anchors on the total. The price (€49/mo = €588/yr) becomes a 3× discount, which is the actual story. Stack order matters: the most desirable thing first, the bonus last. Never bury the dashboard inside the methodology vault. Lead with the thing the buyer wants most.",
    links: [
  ...
  },
  {
    ...
    content:
      "Money close fires for the spreadsheet buyer. Identity close fires for the engineer who's tired of pretending to be a partner. Pricing close fires for the rate-anchor, €1,728 retail vs €588/yr. Urgency close fires for the calendar, every Monday skipped is one 21-47-day window closed. Encore is the safety net for everyone, eight lines, the whole offer in one block, before the FAQ. One of the five always lands; you don't pick, you stack.",
    links: [
