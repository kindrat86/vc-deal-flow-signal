    ...
    dataset: [
      ...
      },
      {
        ...
        distribution: [
          {
            "@type": "Distribution",
            "dct:title": "JSON (full snapshot)",
            accessURL: `${SITE}/api/corpus.json`,
            downloadURL: `${SITE}/api/corpus.json`,
            mediaType: "application/json",
            "dct:format": "application/json",
          },
          {
            "@type": "Distribution",
            "dct:title": "NDJSON (one record per line, diffable)",
            accessURL: `${SITE}/api/corpus.jsonl`,
            downloadURL: `${SITE}/api/corpus.jsonl`,
            mediaType: "application/x-ndjson",
            "dct:format": "application/x-ndjson",
          },
          {
