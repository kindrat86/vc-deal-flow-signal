...
4. **Dashboard Beta — €49/month** (founding-member rate; list price €49/month). ${totalStartups} startups ranked across ${activeSectors.length} sectors, refreshed weekly, with sector filters and five-quarter historical comparison.
...
6. **Insider Circle — €197/month** (founding-member rate; list price €197/month). Everything in Dashboard plus private Telegram group, custom watchlists, JSON API access, bulk CSV pulls, webhook delivery on threshold triggers.
