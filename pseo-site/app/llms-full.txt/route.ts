...
4. **Dashboard, €49/month** (the €9.97/month founding rate closed 2026-06-30; founding subscribers keep it for life). ${panelClaim} startups ranked across ${activeSectors.length} sectors, refreshed weekly, with sector filters and five-quarter historical comparison.
