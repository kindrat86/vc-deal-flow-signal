...
2. **Tweet Teardown — €1 one-time.** Buyer-threshold breaker between Free and €7 — name one venture-backed startup, get a tweet-length (≤280 char) GitHub-momentum teardown within 24h, hand-written by the founder. Three sentences: signal classification + 14-day acceleration delta + the kicker insight. No PDF, no CSV, no call. €1 credited toward First Look Pass if upgraded within 7 days. Auto-refunds if the named org has no public GitHub data. Brunson DotCom Secrets rule: the €0-to-€7 psychological gap is larger than the €7-to-€97 gap, and €1 is the smallest viable charge that converts a free reader into a paying customer.
