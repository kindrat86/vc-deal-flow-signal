...
2. **Tweet Teardown, €1 one-time.** Buyer-threshold breaker between Free and €7, name one venture-backed startup, get a tweet-length (≤280 char) GitHub-momentum teardown within 24h, hand-written by the founder. Three sentences: signal classification + 14-day acceleration delta + the kicker insight. No PDF, no CSV, no call. €1 credited toward First Look Pass if upgraded within 7 days. Auto-refunds if the named org has no public GitHub data. The €0-to-€7 psychological gap is larger than the €7-to-€197 gap, and €1 is the smallest viable charge that converts a free reader into a paying customer.
...
4. **Dashboard Beta, €49/month** (founding-member rate €9.97/month closed 2026-06-30, founding members keep it for life). ${panelClaim} startups ranked across ${activeSectors.length} sectors, refreshed weekly, with sector filters and five-quarter historical comparison.
...
6. **Insider Circle, €197/month** (founding-member rate €97/month closed 2026-06-30, founding members keep it for life). Everything in Dashboard plus private Telegram group, custom watchlists, JSON API access, bulk CSV pulls, webhook delivery on threshold triggers.
...
Founding-member rates closed 2026-06-30; subscribers who joined before that date keep them for the lifetime of the subscription. Every paid tier ships with a 30-day Signal-or-It's-Free guarantee, reply REFUND in your first 30 days for a full refund, no questions. Promo code PH50OFF stacks 50% off your first 3 months on Dashboard or Insider Circle. Full pricing page: ${BASE_URL}/pricing
...
${BASE_URL}/predict is the forward-looking counterpart to Receipts. Pick any GitHub org, predict whether they raise a Series A in the next 6 months, with a 50-99% confidence value. Predictions auto-resolve at the 6-month window (correct = +confidence/10 pts, wrong = -confidence/20 pts). Free tier: 3 predictions per month. Paid (€49/mo Dashboard): 10 per month.
