...
<p>So instead of writing another apologetic cold email, I built a system that reads that public engineering activity for me. Across 400+ venture-backed orgs. Every week. Mechanically. Without the talking-myself-out part. No code-reading on your end, it surfaces the startups heating up, you make the calls.</p>
...
<p>Since Day 0 the engine has indexed 400+ venture-backed GitHub orgs continuously, surfaced ~12 Sunday digests of 5 ranked acceleration signals (≈60 names on your radar before consensus formed), published 3 monthly Sector Deep Dives, and logged confirmed funding / launch / re-rating events against panel orgs that hit acceleration threshold during the window. The Receipts ledger has the names + dates: <a href="${SIGNALS}/wins" style="color:#0ea5e9;">${SIGNALS}/wins</a>.</p>
 ...
 *
 * Day 30 reveals "or run it across 400+ orgs in 4 seconds with the MCP" and
...
<p>Tomorrow is the wrap. I'll show you how to compose all six signals into a single score, and how to run it across 400+ startup orgs in four seconds.</p>
<p>Talk soon, <br>${FROM_NAME}</p>
`),
  },
  ...
  {
    subject: "Day 7, The composite, and 400+ orgs in 4 seconds",
...
<p>Free because the methodology is published CC BY 4.0 at <a href="https://ssrn.com/abstract=6606558" style="color:#0ea5e9;">ssrn.com/abstract=6606558</a>. We charge for scale (the live engine across 400+ orgs and the custom Sector Sweep), not for the framework.</p>
<hr style="border:none;border-top:1px solid #1e293b;margin:24px 0;">
...
<p>This is the procedure the live engine runs every Monday at 06:00 UTC across 400+ orgs in 4 seconds. You're learning the manual version so you can defend any number the engine produces.</p>
...
<p>If the Sunday digest doesn't fit your sector, the underlying engine has 400+ orgs and 30+ sector tags. The Dashboard rung filters by your sector with the same five-orgs-per-week rhythm.</p>
...
<p>I tried two fixes before I built Agent Credits. First, I tried higher Insider tiers, €197 → €197 → €497. The math broke immediately: a single agent scaling across 400+ orgs ends up running ~30,000 deep-signal calls in a weekend. €497/month doesn't cover the GitHub-API cost layer underneath, let alone the regression compute.</p>
 ...
 *   D10, the math close. €7 credit + €42 = €49 (one month Dashboard). Frame
...
<li><strong>Are you considering the Dashboard?</strong> If yes, the €7 you paid credits 100% toward your first month of the €49/mo Dashboard. The total cost of trying it for one month is €42, less than one data-vendor lunch to see startups heating up across every sector instead of one.</li>
</ol>
...
`, "firstlook-d7"),
  ...
  {
    subject: "€7 credit + €42 = one month of the Dashboard",
    delayMs: 10 * ONE_DAY,
    html: wrap(`
<p>The math, plain.</p>
...
const D0_F: SoapOperaEmail = {
  ...
  delayMs: THIRTY_MIN,
  html: wrap(`
<p>Welcome. Let me be clear up front, because people get confused: GitDealFlow is a tool, not a fund. I'm not a VC, I'm not competing with you for the deal. It reads startups' public GitHub engineering activity and flags the ones heating up in your sectors, before they raise or hit the press. You don't crunch anything, it surfaces them, you just look.</p>
<p>You told me on the quiz that you've written 0-1 angel checks in the past year, exploring, learning, maybe one day. Important: <strong>the free Sunday digest is the version for your tier, full stop.</strong></p>
<p>I built this after I missed a Series A I'd flagged in my own notebook three weeks before it announced. The team was clearly shipping faster, four new contributors, three new infrastructure repos in fourteen days, all sitting in plain sight on a public GitHub org. I'd talked myself out of writing the cheque. The investors who got in had read exactly the same early engineering signal and didn't.</p>
<p>So I built a system that reads that public activity for me. Across 400+ venture-backed orgs. Every week. Mechanically. Your free Sunday digest is the top five startups heating up in your sectors, ranked, sector-tagged, no commitment.</p>
<p>For someone in your tier, that's enough. Read for ten years and write your first cheque informed. The &euro;7 First Look Pass exists if your cadence ever picks up to 2-5 checks/year, but I'd rather you read for free for a long time than upgrade once and resent it.</p>
...
const D0_T: SoapOperaEmail = {
  ...
  delayMs: THIRTY_MIN,
  html: wrap(`
<p>Welcome. First, the plain version so there's no confusion: GitDealFlow is a tool, not a fund. I'm not a VC, not competing with you for the deal. It reads startups' public GitHub activity and flags the ones heating up in your sectors, before they raise or hit the press, you just look.</p>
<p>You told me on the quiz that you've written 2-5 angel checks in the past year, building cadence, sector-leaning. The right rung for your tier is the <strong>&euro;7 First Look Pass</strong>, and I'm going to spend the next 30 days showing you why it pays for itself the first time you run it.</p>
<p>Here's the story this started with. I was tracking a fintech-infra startup. No press, no AngelList buzz, no warm intros circulating. But their GitHub told a different story: the team was suddenly shipping faster, four new senior contributors from a public Series-B company, three new infrastructure repos spun up over a single weekend. I noted it. I closed the laptop. Three weeks later, $4M Series A.</p>
<p>The signal was public. The methodology is published (SSRN n=219, 21-47 day median lead time). The only thing missing was someone willing to pay &euro;7 once, pick a sector, and have the deep dive in their inbox in 24 hours.</p>
<p>That's literally the First Look Pass. Pick fintech-infra, AI/ML, dev tools, healthtech, whichever sits closest to your thesis. I send the 14-page PDF + raw CSV + walkthrough. If three orgs land that you'd genuinely consider writing into, the &euro;7 was the right call. If not, the report and CSV are still yours.</p>
...
<p>Tomorrow: why "GitHub data is noise" is the most common objection, and why it's wrong in a specific, measurable way for your check-size.</p>
<p>Talk soon,<br>${FROM_NAME}</p>
...
<p>You scan in twenty seconds. The third entry is an AI-infra startup you've never heard of, three new senior contributors joined this week, all from a public Series-B company you respect. The README was rewritten Saturday night. The team is clearly shipping faster than it was a month ago.</p>
<p>You open the founder's email, it's right there in the git log, and write four lines: "Saw the README rewrite + the new contributors. The work looks like the kind I follow. If you ever want a 20-minute call about what early angel allocation looks like for the round after this one, I'm easy to reach."</p>
<p>You don't have a check ready. You're not pretending to. You're playing the long game, three quarters of Sunday-morning reading, twelve to twenty cold emails sent, two or three real relationships built. By the time you write your first &euro;5k cheque next year, the founder you back is one of the founders you've been reading for ten months.</p>
<p>That's what the free digest is for, on your tier. Not "deal flow", <strong>taste flow</strong>. You're calibrating which early engineering signals match the kind of company you'd want to back, and you're doing it on a budget of zero euros and twenty minutes a week.</p>
<p>The Sunday digest stays free forever. The &euro;7 First Look Pass exists if your cadence ever moves to 2-5/year, at that point the value-per-euro math flips and a single sector deep-dive saves you a week of evenings. But that's <em>your</em> decision and <em>your</em> timing, not mine.</p>
<p>Tomorrow I'll send the most-asked objection at your tier, "if the data is public, where's the edge?", with the answer that takes about ninety seconds to read and shifts the whole frame.</p>
<p>Talk soon,<br>${FROM_NAME}</p>
...
const D5_T: SoapOperaEmail = {
  ...
  delayMs: THIRTY_MIN + 5 * ONE_DAY,
  html: wrap(`
<p>Picture this. It's a Tuesday afternoon in August. Your &euro;7 First Look Pass on fintech-infra (or whichever sector matches your thesis) landed in your inbox at lunch. Fourteen pages, raw CSV, written walkthrough, the artefact that compresses three weeks of analyst time into one PDF.</p>
<p>You scan the top 25 ranked orgs first. Three names you already know. Two you've heard mentioned. <em>Twenty</em> you've never heard of. The walkthrough flags three pre-Crunchbase early-stage targets, the thesis-tagged surprises, the kind of orgs where a polite cold email this week could be a 20-minute call next week.</p>
...
<p>Then you do the math. &euro;7. Twenty unknown orgs surfaced, four of them genuinely interesting enough to email. Even one of those four turning into a 20-minute call, at angel range with even a 5% probability of investing, pays back the &euro;7 ~700 times over. The &euro;7 wasn't the question; the question was whether the methodology produced names you wouldn't have seen otherwise. The CSV says yes.</p>
<p>That's the test. If the First Look Pass surfaces three orgs you'd genuinely consider, the &euro;7 was the right call. If not, you keep the report and the CSV anyway and you've spent &euro;7 to find out. Either way the credit-back means upgrading to the Dashboard within 14 days costs you &euro;0 in additional out-of-pocket, the &euro;7 already paid.</p>
<p>Tomorrow: the most-asked objection at your tier, "if it's public, where's the edge?", answered cleanly in ninety seconds.</p>
...
<p>Talk soon,<br>${FROM_NAME}</p>
<p style="color:#64748b;font-size:14px;">P.S. The first 50 First Look passes locked the &euro;7 price. After that the price moves to &euro;19. The credit-back to Dashboard stays at 100% indefinitely, that's the rung structure, not a launch promo.</p>
`),
};
...
const D45_F: SoapOperaEmail = {
  ...
  delayMs: THIRTY_MIN + 45 * ONE_DAY,
  html: wrap(`
<p>You signed up forty-five days ago telling me you've written 0-1 angel checks in the past year. Six Sunday digests have hit your inbox since. About thirty ranked names you've now had on your radar before consensus formed.</p>
<p>The honest question I'd ask at this point: <strong>has your cadence shifted?</strong></p>
<p>If you've gone from "exploring, learning" to "I've written one cheque this quarter and I'm circling a sector", that's a real shift, and the right next rung is the <strong>&euro;7 First Look Pass</strong>. Pick the sector you're circling, get the 14-page deep dive + raw CSV in 24 hours, credit 100% toward Dashboard if you upgrade within 14 days. &euro;7 is the price of a coffee in central Lisbon. It's the lowest-friction way to test step 5 of the conversion story on your own thesis without committing to a subscription.</p>
<p>If your cadence hasn't shifted, still 0-1 cheques/year, still calibrating taste, <strong>nothing changes</strong>. The free Sunday digest stays exactly as it is. I'd rather you read for ten years and write your first cheque informed than upgrade once and resent it.</p>
<p>The First Look isn't a "graduate now or be left behind" pitch. It's the rung above your tier, named honestly, available the moment your cadence justifies it. If forty-five days from today you're in the same place, keep reading, keep calibrating. If forty-five days from today you've written two more cheques, the First Look is here.</p>
...
const D45_I: SoapOperaEmail = {
  ...
  delayMs: THIRTY_MIN + 45 * ONE_DAY,
  html: wrap(`
<p>You signed up forty-five days ago at fund-tier, 20+ checks/year, fund or syndicate operator. Six Sunday digests + (if you took the rung) six Insider briefings have landed. The 24-hour lead has been running for six full sourcing weeks now.</p>
...
const D60_T: SoapOperaEmail = {
  ...
  delayMs: THIRTY_MIN + 60 * ONE_DAY,
  html: wrap(`
<p>Most weeks the right rung at your tier is the &euro;7 First Look or the &euro;49/mo Dashboard. Both run on the same engine, both are tuned for the 2-5 cheque/year cadence you described on signup.</p>
<p>About once a year, maybe once a quarter if your thesis is sharp, there's a different shape that's useful: <strong>going all-in on one sector for a single weekend</strong>, with a 40-page artefact you can paste into your decision memo or share with a co-investor.</p>
<p>That's the Sector Sweep. &euro;1,997 one-time. I'm naming it now not because it's the right rung for your tier <em>today</em>: at 2-5 cheques/year, it almost certainly isn't, but because if your cadence ever moves to 8-10/year and you start running a sharper sector thesis, this is the artefact that compresses three weeks of work into a weekend of reading.</p>
...
const D75_F: SoapOperaEmail = {
  ...
  delayMs: THIRTY_MIN + 75 * ONE_DAY,
  html: wrap(`
<p>Quick note for the tier you signed up at, 0-1 angel checks/year, exploring, calibrating taste.</p>
