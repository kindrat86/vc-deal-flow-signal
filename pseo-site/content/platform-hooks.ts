...
export const UNIVERSAL_STORY = {
  ...
  narrative:
    "Public commit-velocity acceleration crosses a falsifiable threshold 21–47 days before a Series A round closes. We track 4,200+ orgs, methodology peer-indexed (SSRN 6606558), n=219 paired observations, 68% hit rate at 33-day median lead.",
  offer:
