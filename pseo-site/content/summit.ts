...
export const TALKS: SummitTalk[] = [
  // DAY 1 — Foundations: The Acceleration Era
  {
    ...
    title: "The Big Domino: Why Engineering Acceleration Leads VC by 31 Days",
  ...
  },
  {
    ...
    relatedRoutes: [
      ...
      { label: "ICP — Dream 100", href: "/dream-100" },
    ],
  },
  {
  ...
  },
  {
    ...
    order: 2,
    dayCaption: "Day 4 — Operationalizing · From Signal to Term Sheet",
    title: "ICP Engineering: Defining a Dream-100 by GitHub Behavior",
    subtitle: "The Brunson Dream-100 list, but defined by code-side behavior instead of demographic guessing.",
    speaker: "The Data Nerd",
    speakerRole: "Founder, VC Deal Flow Signal",
    abstract:
      "Russell Brunson's Dream-100 framework asks you to name the 100 organizations whose followers are your dream customers. We translate that to GitHub-behavior terms. By the end of the talk you have a reproducible filter that surfaces your own Dream-100.",
    takeaways: [
      "Translating Brunson's Dream-100 to engineering-behavior filters",
    ...
    notes: [
      ...
      "Maintain it as a rolling 90-day list, not a one-shot snapshot. Re-run the filter every quarter. About 30–40 percent of the names will roll off (signal weakened, fundraise happened, sector pivot) and a similar number of new names will roll on. The Dream-100 you ship in May 2026 should look meaningfully different from the one you ship in August 2026. That rolling nature is a feature — it keeps you out of the trap of fixating on names that no longer match your thesis.",
    ],
    relatedRoutes: [
      { label: "Dream-100 ICP", href: "/dream-100" },
      { label: "Distribution map", href: "/distribution" },
  ...
  },
  {
    ...
    abstract:
      "Autonomous diligence agents are entering venture sourcing this year. We walk through the MCP server architecture, the x402 USDC pay-per-call endpoint, and the JSON-RPC interface that lets a Claude or GPT-class agent screen the universe of 4,200 startups in seconds.",
    takeaways: [
  ...
  // DAY 5 — Future: The Stadium Pitch
  {
    slug: "next-five-years-code-eats-pitch-deck",
    day: 5,
    order: 1,
    dayCaption: "Day 5 — Future · The Stadium Pitch",
  ...
  },
  {
    ...
    order: 3,
    dayCaption: "Day 5 — Future · The Stadium Pitch",
    title: "The Stadium Pitch: Falsifiable Predictions in a Hype-Driven Industry",
    subtitle: "Once a quarter, in front of an imaginary stadium of 50,000 people, we make a falsifiable prediction. Here's the next one.",
    speaker: "The Data Nerd",
    speakerRole: "Founder, VC Deal Flow Signal",
    abstract:
      "Russell Brunson's Stadium Pitch is the talk you'd give if you had 50,000 people in front of you. Ours, once a quarter, is one falsifiable prediction with a specific named candidate, a specific named horizon, and a public scorecard. Here is the Q3 2026 prediction.",
    takeaways: [
    ...
    relatedRoutes: [
      { label: "State of GitHub — Stadium Pitch", href: "/state-of-github" },
      { label: "Predicted Series A", href: "/predicted" },
      { label: "Attestations", href: "/attestations" },
    ],
  },
