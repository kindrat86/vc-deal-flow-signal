...
export const TALKS: SummitTalk[] = [
  ...
  },
  {
    ...
    abstract:
      "Autonomous diligence agents are entering venture sourcing this year. We walk through the MCP server architecture, the x402 USDC pay-per-call endpoint, and the JSON-RPC interface that lets a Claude or GPT-class agent screen the universe of 350+ startups in seconds.",
    takeaways: [
    ...
    freeWindowHours: 24,
    notes: [
      "Agent-native sourcing is here, not coming. Funds that haven't yet built agent workflows are at the same disadvantage that funds without spreadsheets were at in 1985. The reason agents change the sourcing math is throughput, a Claude agent can screen 350+ organizations in 90 seconds against a custom thesis prompt, compared to the 8 hours it would take a human analyst to skim the same list. The bottleneck stops being analyst time and starts being signal quality.",
