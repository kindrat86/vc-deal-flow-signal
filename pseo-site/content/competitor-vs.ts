...
export const competitorVsPairs: CompetitorVs[] = [
  ...
  },
  {
    ...
    decision: "Pick Harmonic.ai when you are an institutional firm running proactive sourcing and you want the earliest possible signal, at incorporation, across all sectors including non-technical ones. Pick Tracxn when you need analyst-driven sector research, market context, and strong Asian startup coverage, with tiered pricing that is lighter than a full enterprise contract. Consider using both when you want proactive discovery plus deep sector research: Harmonic.ai surfaces early teams, and Tracxn provides the sector maps and market context to evaluate them. They are not substitutes, since Harmonic is a leading signal and Tracxn is a lagging database, so neither overlaps much with the other's core user. Both leave a gap for investors who want engineering-acceleration lead time on technical startups, which neither tool measures directly.",    faqs: [
        // GSC 28d: 48 imps pos 4.0
        { question: "How does Harmonic compare to Tracxn?", answer: "Tracxn is a sector-mapped database with strong Asia coverage, sold on tiered plans; Harmonic is an enterprise discovery engine built on team and incorporation signals, priced after demo. Tracxn excels at structured sector landscapes, Harmonic at earliest-stage team discovery. Asian-market investors often keep Tracxn as the backbone and layer specialist signals on top." },
    ],
  ...
  },
  {
    ...
    decision: "Pick PitchBook when you are an LP, GP, or banker who needs the industry-standard reference for fund performance, secondaries, M&A, and benchmarking, and your firm can absorb its $20k-plus annual enterprise pricing. Pick Dealroom when you are a European-focused VC or analyst who needs granular sector maps and the deepest European coverage, typically at a lower price point than PitchBook. Consider using both when you are a global institutional firm that needs PitchBook as the benchmarking reference and Dealroom for European portfolio and sector work, though this doubles your data budget and is rarely justified below a certain firm size. Neither tool is a leading signal, since both are curated post-announcement data, so neither helps with proactive sourcing of companies that have not yet raised.",    faqs: [
        // verbatim PAA 2026-08-17, distinct question from the alternatives form
        { question: "Is there a free version of PitchBook?", answer: "No. PitchBook has no free tier and no self-serve trial; access starts with an enterprise subscription sold through its sales team. Its industry reports are free downloads and show the research style, but not the data platform. Free access to parts of the workflow exists elsewhere: Crunchbase's free lookups and VC Deal Flow Signal's weekly Signal Report for leading signals." },
        // GSC 28d to 2026-09-22: "dealroom vs" 469i p8.0, exact "dealroom vs pitchbook" 4i p2.0,
        // both 0 clicks. Which-is-better is the observed PAA form in the sibling
        // crunchbase-vs-pitchbook family. Answer reuses only facts already on this page.
        { question: "Dealroom vs PitchBook: which is better?", answer: "It depends on the job. PitchBook is better as the industry-standard reference for fund performance, LP-GP records, valuations, and M&A, if your firm can absorb its $20k-plus annual enterprise pricing. Dealroom is better for European-focused teams that need the deepest European coverage and granular sector taxonomy, typically at a lower price point than PitchBook. Both are curated post-announcement databases, so neither surfaces companies before they raise; that leading-signal layer is what VC Deal Flow Signal's weekly Signal Report covers." },
    ],
    ...
    faqs: [
      {
        ...
        // verbatim PAA on 2 SERPs incl. this page's cluster (harmonic ai pricing)
        { question: "How much does Harmonic.ai cost?", answer: "Harmonic.ai does not publish pricing. It is sold enterprise-style: a demo request, a discovery call, then a custom annual quote, with public reports placing contracts in the high five figures per year. There is no self-serve tier and no free trial. Budget-conscious solo investors usually pair cheaper tooling instead, for example Crunchbase Pro plus VC Deal Flow Signal at EUR 49/mo." },
        // verbatim PAA on 2 SERPs 2026-08-17
        { question: "What are some alternatives to Harmonic.ai?", answer: "Depending on the job: PitchBook for institutional reference data, Dealroom for European coverage, Tracxn for Asian markets, Affinity for network-based CRM, Crunchbase Pro for affordable verification, and VC Deal Flow Signal for engineering-momentum signals on technical startups at EUR 49/mo. The last one is the only leading-signal option priced for individual investors." },
        // verbatim PAA (entity-disambiguation; two Harmonics exist, verified vs TechCrunch/Preqin/Unicorner)
        { question: "Who are the founders of Harmonic.ai?", answer: "The startup-data platform harmonic.ai was founded in 2020 by Bryan Casey and Ajay Sohmshetty, with Max Ruderman as CEO; TechCrunch covered its $23M Series A in November 2022. Note the name collision: Harmonic, the mathematical-AI lab founded by Robinhood's Vlad Tenev with Tudor Achim, is a different company. This site compares the startup-data platform." },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      // GSC 90d: head family 129i p34.6 direct (28d) + 543i p24.2 / 169i p20.4 via the
      // legacy /compare/pitchbook-vs-cb-insights 308 target; 0 clicks. Depth, not relevance.
      { question: "How does CB Insights compare to PitchBook?", answer: "CB Insights is market intelligence: proprietary Mosaic company scores, industry analytics, market sizing, and analyst research briefs, typically $35,000+/yr, sold to strategy and research teams. PitchBook is a private-markets database: fund performance, valuations, M&A, and LP-GP records, typically $20,000+/yr, used for due diligence and portfolio management. CB Insights answers what is happening in a market; PitchBook holds the verified record on a company or fund. Both are enterprise-priced with no self-serve tier." },
      // GSC 28d: "cb insights pricing" 3i p40.0 on this page; pricing is the core of the head queries
      { question: "How much does CB Insights cost compared to PitchBook?", answer: "Neither publishes list prices; both are annual, sales-led enterprise contracts. CB Insights typically starts around $35,000 per year and scales with seats and modules. PitchBook typically starts around $20,000 per year and scales with seats and data modules. Entry pricing for CB Insights is generally the higher of the two, and neither offers a meaningful free tier or self-serve trial, so individual investors and small funds are outside both target markets." },
      // GSC 90d: "pitchbook vs cb insights comparison" 10i p10.3; "difference between X and Y" is the
      // observed form in the sibling crunchbase-pitchbook family (12i + 7i)
      { question: "What is the difference between CB Insights and PitchBook?", answer: "The core difference is data type. PitchBook is a structured record of private-market transactions: who raised, at what valuation, which fund invested, and which exits happened, verified by analysts after announcement. CB Insights is an analytics layer that scores companies with Mosaic, sizes markets, and tracks trends on top of its own company data. A typical institutional workflow uses PitchBook as the record and CB Insights as the interpretation. If you buy only one, PitchBook for deal and fund records, CB Insights for market research." },
      // GSC 90d: diligence-buyer intent inside the head family ("cb insights vs pitchbook", 129i+543i)
      { question: "Is CB Insights or PitchBook better for due diligence?", answer: "For company-level due diligence, round histories, valuations, investor and cap-table records, and M&A, PitchBook is the stronger fit. For market-level diligence, market sizing, trend reports, emerging-category briefs, and company health scores, CB Insights. Teams that run both usually assign PitchBook to the deal team and CB Insights to the strategy or research team. Below enterprise budgets neither is required for sourcing: Crunchbase at $49/mo Pro plus a free leading-signal source covers the individual-investor verification workflow." },
    ],
  },
  {
...

  {
    ...
    faqs: [
      // GSC 28d: verbatim PAA-form query "how does harmonic compare to cb insights?" 7i p9.3; also
      // 1i p1.0 landing on the pitchbook-cbi page. Highest-intent question this page earns.
      { question: "How does Harmonic compare to CB Insights?", answer: "Harmonic.ai is a sourcing platform: it pattern-matches founding teams and networks at incorporation to surface companies before anyone announces them. CB Insights is a research platform: proprietary Mosaic company scores, industry analytics, and analyst briefs for understanding markets, at typically $35,000+/yr. Harmonic is built for proactive deal discovery; CB Insights for strategic research and trend analysis. Both are enterprise-priced and sales-led, so the choice is role-based: sourcing versus research." },
      // GSC 28d: "evaluate the startup discovery company cb insights on harmonic product" 6i p7.5;
      // agent-eval string, but the underlying buyer question is positioning, mirrored from the
      // harmonic-vs-pitchbook PAA family that lifted to p4-6 with this pattern
      { question: "Is Harmonic a CB Insights competitor?", answer: "Only partially. They overlap on company data, but they monetize different jobs. Harmonic competes for the sourcing workflow: finding companies and people early, before funding announcements. CB Insights competes for the market-intelligence workflow: market sizing, industry analytics, Mosaic scoring, and analyst research. A firm that buys both usually assigns them to different teams, which is why most buyers do not treat them as direct substitutes. Direct CB Insights competitors sit in market intelligence; direct Harmonic competitors sit in sourcing." },
      // GSC 90d: Mosaic is the single named CBI differentiator across this site's CBI copy
      // (competitor-vs verdicts + comparisons.ts), the recurring expert question in CBI comparisons
      { question: "What is the CB Insights Mosaic Score vs Harmonic's signals?", answer: "Mosaic is CB Insights' proprietary company health and trajectory score computed from its market data, used to rank and monitor companies inside research workflows. Harmonic's signals are team and network patterns observed at incorporation, used to surface companies for outreach. Mosaic scores a company you already know about; Harmonic flags companies you do not. Neither is externally auditable, so institutional buyers validate both against their own portfolio before relying on either." },
      // GSC 90d: pricing anchors every head query in the family ("cb insights pricing" 3i p40);
      // mirrored pricing-QA form from harmonic-vs-pitchbook (153i p3.8) that won the PAA slot
      { question: "How does Harmonic's pricing compare to CB Insights?", answer: "Neither publishes list prices. CB Insights is typically $35,000+/yr, annual and sales-led, with no self-serve tier. Harmonic quotes only after a demo and is generally reported in a similar enterprise range, scaling with seats. Both assume an institutional buyer. For context below that tier, VC Deal Flow Signal publishes open pricing, EUR 49/mo for the Dashboard with a free tier." },
    ],
  },
];
