...
export const cursorCollabPost: BlogPost = {
  ...
  description:
    "A working Cursor MCP recipe: 4 lines of JSON, 5 paste-ready prompts, and your AI editor can answer 'is this commit pattern unusual' from inside the file you're reading. Built on GitDealFlow's 350+ startup engineering acceleration panel.",
  summary:
