...
// ---------------------------------------------------------------------------
// Niche-down index-prune policy (2026-08-16, audit "content pruning 55", guard §48).
// Ground truth: fresh GSC 90d page-filtered pull (2026-08-16,
// gitdealflow-rank-tracker/data/gsc-niche-down-90d.json): 200 leaves,
// 109 rows, 828 imps, 1 click. Cluster live since 2026-05-22 (86d > 60d
// seasoning floor, pruning on data is legitimate).
// KEEP a leaf with ANY of: clicks>0, imps>=10, avg pos<=30.
// NOINDEX the rest: 91 never-impressed leaves + 15 with imps<10 AND pos>40.
// Kept 94 leaves carry 684/749 leaf impressions (91%); the 106 pruned carry
// ZERO clicks, max 9 imps, unwinnable positions. Pages STAY LIVE (200,
// follow) so browse and link equity survive; they only exit the index and
// the sitemap. Hub + all 20 sector hubs always stay indexable.
// Re-run quarterly: refresh GSC, move slugs between the Set and the wild,
// keep the invariant "no pruned slug carries a click", update §48 count.
export const NICHE_PRUNE_2026_08: ReadonlySet<string> = new Set([
  "agtech/farm-financial-management",
  "agtech/irrigation-optimization-edge-devices",
  "agtech/livestock-vision-monitoring",
  "agtech/precision-spraying-software",
  "agtech/satellite-yield-prediction",
  "agtech/soil-microbiome-analytics",
  "agtech/vertical-farm-control-systems",
  "ai-ml/agent-orchestration-frameworks",
  "ai-ml/fine-tuning-tools-for-non-ml-teams",
  "ai-ml/multimodal-rag-stacks",
  "ai-ml/on-device-llm-runtimes",
  "climate-tech/carbon-accounting-for-smbs",
  "climate-tech/climate-risk-modeling-apis",
  "climate-tech/fleet-electrification-analytics",
  "climate-tech/household-electrification-marketplaces",
  "climate-tech/methane-leak-detection-software",
  "climate-tech/regenerative-ag-data-platforms",
  "cybersecurity/llm-firewall-tooling",
  "cybersecurity/oss-vulnerability-graphs",
  "cybersecurity/ssh-key-lifecycle-management",
  "cybersecurity/supply-chain-attack-detectors",
  "data-infrastructure/anti-entropy-sync-libraries",
  "data-infrastructure/change-data-capture-tools",
  "data-infrastructure/data-contract-platforms",
  "data-infrastructure/llm-cache-layers",
  "data-infrastructure/real-time-feature-stores",
  "data-infrastructure/time-series-databases-for-ml",
  "data-infrastructure/vector-database-engines",
  "developer-tools/doc-from-code-generators",
  "developer-tools/terraform-alternatives",
  "ecommerce-infrastructure/dropshipping-quality-vetting",
  "ecommerce-infrastructure/headless-cms-for-stores",
  "ecommerce-infrastructure/multi-channel-marketplace-uploaders",
  "ecommerce-infrastructure/post-purchase-experience-saas",
  "ecommerce-infrastructure/returns-and-refund-automation",
  "ecommerce-infrastructure/shopify-app-replacements",
  "ecommerce-infrastructure/subscription-billing-edge-cases",
  "edtech/ai-flashcard-generators",
  "edtech/classroom-ai-policy-compliance-tools",
  "edtech/k12-iep-automation",
  "edtech/no-code-curriculum-builders",
  "edtech/peer-grading-platforms",
  "edtech/video-comprehension-assessment",
  "edtech/vocational-credentialing-rails",
  "enterprise-saas/agent-permissioning-for-saas",
  "enterprise-saas/internal-llm-copilots-by-role",
  "enterprise-saas/runbook-from-doc-generators",
  "enterprise-saas/sales-engineering-copilots",
  "enterprise-saas/vendor-spend-intelligence",
  "enterprise-saas/workflow-automation-for-revops",
  "fintech/ai-tax-loss-harvesting",
  "fintech/b2b-invoice-financing-rails",
  "fintech/expense-management-for-solopreneurs",
  "fintech/small-business-credit-underwriting",
  "fintech/stablecoin-treasury-tooling",
  "gaming/ai-npc-dialogue-engines",
  "gaming/esports-tournament-saas",
  "gaming/kids-game-safety-filters",
  "healthcare/ai-scribe-for-specialists",
  "healthcare/chronic-condition-monitoring-apps",
  "healthcare/fertility-tracking-with-ai",
  "healthcare/prior-authorization-automation",
  "healthcare/telehealth-prescription-routing",
  "healthcare/voice-first-ehr",
  "hr-tech/equity-administration-saas",
  "hr-tech/hr-chatbot-replacements",
  "hr-tech/internal-mobility-marketplaces",
  "hr-tech/learning-and-development-llms",
  "hr-tech/performance-review-llms",
  "legal-tech/e-discovery-llms",
  "legal-tech/immigration-paperwork-automation",
  "legal-tech/ip-management-saas",
  "legal-tech/regulatory-monitoring-for-startups",
  "proptech/construction-bidding-marketplaces",
  "proptech/mortgage-underwriting-llms",
  "proptech/property-management-for-mom-and-pops",
  "proptech/short-term-rental-ops",
  "robotics/agricultural-robotics-os",
  "robotics/robot-fleet-management",
  "robotics/robot-perception-models",
  "robotics/robotics-data-labeling-tools",
  "robotics/surgical-robotics-software",
  "robotics/telepresence-platforms",
  "robotics/warehouse-robotics-saas",
  "social-community/hobbyist-marketplace-rails",
  "social-community/niche-dating-apps",
  "social-community/voice-first-social",
  "space-tech/debris-tracking-apis",
  "space-tech/lunar-mission-mission-control",
  "space-tech/propulsion-simulation-tools",
  "space-tech/satellite-data-marketplaces",
  "space-tech/smallsat-fleet-management",
  "space-tech/space-tourism-booking-platforms",
  "supply-chain/customs-automation-llms",
  "supply-chain/esg-tracing-tools",
  "supply-chain/returns-reverse-logistics",
  "supply-chain/supplier-risk-monitoring",
  "supply-chain/trade-finance-rails",
  "web3/account-abstraction-toolkits",
  "web3/defi-portfolio-managers",
  "web3/mev-protection-libraries",
  "web3/nft-licensing-platforms",
  "web3/onchain-compliance-tools",
  "web3/prediction-market-infrastructure",
  "web3/real-world-asset-tokenization",
  "web3/web3-game-rails",
]);

/** True when a sub-niche leaf is index-pruned (2026-08 policy, §48). */
export function isNichePruned(sector: string, subniche: string): boolean {
  return NICHE_PRUNE_2026_08.has(`${sector}/${subniche}`);
}
