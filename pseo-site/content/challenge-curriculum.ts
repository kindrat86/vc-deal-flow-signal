...
export const CHALLENGE_DAYS: readonly ChallengeDay[] = [
  ...
  },
  {
    ...
    tomorrowTeaser:
      "Tomorrow is the wrap. I'll show you how to compose all six signals into a single score, and how to run it across 369 startup orgs in four seconds.",
    retailValue: 89,
  },
  {
    day: 7,
    ...
    oneLine: "Six signals → one score → 369 orgs in 4 seconds.",
    whyItMatters:
    ...
    bonus:
      "Manual version takes ~30 minutes per startup. Monitoring 30 startups manually is a 15-hour week. The fast version runs the same six signals plus a seventh (signal-type classification — hiring burst vs infra buildout vs deploy spike vs framework migration) across 369 orgs continuously. Same framework, different scale.",
    yesterdayRecap:
  ...
  },
  {
    ...
    bonus:
      "This is the procedure the live engine runs every Monday at 06:00 UTC across 369 orgs in 4 seconds. You're learning the manual version so you can defend any number the engine produces.",
    yesterdayRecap:
  ...
  },
  {
    ...
    edgeCase:
      "If the Sunday digest doesn't fit your sector, the underlying engine has 369 orgs and 30+ sector tags. The Dashboard rung filters by your sector, same five-orgs-per-week rhythm.",
    bonus:
