...
const REPORT_2026: AnnualReport = {
  ...
  executiveSummary:
    "Across 4,800 venture-backed GitHub organizations and 52 weekly observation windows, three sector-level structural shifts dominated 2026. AI-native developer tools sustained the highest median commit-velocity acceleration of any tracked sector for 39 of 52 weeks. On-device inference infrastructure saw a contributor-diversity Gini coefficient drop from 0.42 to 0.31, indicating broadening team composition consistent with capital deployment. Verifiable-compute infrastructure saw a 3.7x year-over-year increase in new-repo creation rate. The full panel surfaced 219 confirmed Series A and Series B fundraises with a 22 percent false-positive fraction at a 90-day horizon — a 16-point improvement over the 2025 panel. This report is the first in an annual series.",
  sections: [
    {
      id: "framing",
