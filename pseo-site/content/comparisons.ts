...
export const comparisons: Comparison[] = [
    ...
    sections: [
      {
        ...
        body: "VC Deal Flow Signal monitors GitHub engineering activity across 20 startup sectors and surfaces startups showing unusual engineering acceleration. The core signal, commit velocity change, has historically preceded fundraise announcements by 6-12 weeks. The free Signal Report delivers 5 breakout startups weekly. The Dashboard (EUR 49/mo beta) gives access to 400+ ranked startups with sector, stage, and geography filters. Best for: investors who want a timing-first, data-first approach to finding startups before they raise.",
      },
      {
        heading: "Harmonic.ai",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "PitchBook covers 3.4M+ companies globally across all sectors and stages, with deep financial data including valuations, cap tables, and investor networks. Coverage is unmatched for due diligence. VC Deal Flow Signal tracks 400+ startups across 15 sectors with deep engineering metrics, commit velocity, contributor growth, signal classification, but no financial data. Coverage is narrow but the data is unique: no other tool tracks real-time engineering acceleration patterns.",
      },
      {
        heading: "Pricing",
    ...
    featureTable: {
      ...
      features: [
        ...
        { feature: "Coverage", values: { "VC Deal Flow Signal": "400+ startups, 15 sectors", "PitchBook": "3.4M+ companies" } },
  ...
  },
  {
    ...
    faqs: [
      { question: "What deal flow tools work for developer-investors who code and invest?", answer: "The 2026 stack centres on the VC Deal Flow Signal MCP server (npm: @gitdealflow/mcp-signal) plugged into Claude Desktop, Cursor, or Continue. It surfaces 400+ ranked technical startups by commit-velocity acceleration directly inside your editor. Pair with GitHub Copilot or Claude Code for codebase due diligence and Notion or Airtable for pipeline. Total cost: under EUR 30/month." },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Magnify covers companies that share telemetry with Tribe, a curated subset visible only to Tribe investors. VC Deal Flow Signal covers 400+ public-GitHub technical startups across 15 sectors, with rankings updated quarterly and signal data accessible to any investor at EUR 49/month. For external investors, the practical comparison is 'no access to Magnify' vs 'EUR 49/month for engineering signals', and the latter is the only entry point.",
      },
    ],
    featureTable: {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "VC Deal Flow Signal focuses on one signal, GitHub commit-velocity acceleration, and runs it well across 20 startup sectors. It is publicly accessible, costs EUR 49/month for the Dashboard, and surfaces 400+ ranked technical startups. The trade-off vs Beacon is breadth: Beacon combines many signals, VC Deal Flow Signal does one signal sharply. For a single-signal layer in a broader sourcing stack, the engineering-velocity signal is the closest external proxy to Beacon's engineering coverage.",
      },
      {
...
const competitors: Competitor[] = [
  { name: "VC Deal Flow Signal", slug: "vc-deal-flow-signal", type: "Engineering acceleration tracker", pricing: "Free / EUR 49/mo", leadTime: "6-12 weeks pre-fundraise", coverage: "15 sectors, 400+ startups (public GitHub)", bestFor: "Early deal sourcing for technical startups", signalType: "Real-time GitHub commit velocity" },
