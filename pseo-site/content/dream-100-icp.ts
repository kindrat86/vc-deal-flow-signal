...
export const ICP_SCORES: Record<string, IcpScoreInputs> = {
  ...
  "DotCom Secrets — Russell Brunson": { match: 6, reach: 9, engage: 3 },
  "Expert Secrets — Russell Brunson": { match: 6, reach: 9, engage: 3 },
  "Traffic Secrets — Russell Brunson": { match: 6, reach: 9, engage: 3 },
