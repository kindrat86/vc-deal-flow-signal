...
export const TEARDOWNS: CompetitorTeardown[] = [
  {
    ...
    funnelArch: [
      ...
      },
      {
        ...
        ourMove:
          "€49/mo founding-member rate, locked forever. Public pricing page. The buyer can decide in 30 seconds without scheduling a call.",
      },
      {
...

  {
    ...
    funnelArch: [
      ...
      },
      {
        ...
        ourMove:
          "€49/mo Dashboard. €1,797 Sector Sweep one-time. €197/mo Insider. Three rungs, public. The buyer chooses without asking.",
      },
      {
...

  {
    ...
    funnelArch: [
      ...
      },
      {
        ...
        ourMove:
          "€49/mo founding rate is below the procurement threshold — angels and scouts buy on credit card without asking permission.",
      },
      {
        step: "5 — Enterprise upsell",
        theirMechanic:
