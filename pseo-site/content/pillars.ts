...
export const pillars: Record<string, Pillar> = {
  ...
  "founder-research": {
    ...
    name: "Operator Notes",
    description:
      "First-hand notes from running the dataset, building a longitudinal panel of 400+ startup GitHub orgs, MCP server lessons, and other operator-side observations.",
    keywords: [
      "GitHub dataset",
      "operator notes",
      "MCP server",
