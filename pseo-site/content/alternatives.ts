...
export const alternatives: Alternative[] = [
  {
    ...
    faqs: [
      ...
      { question: "How does Harmonic compare to Grata for deal sourcing?", answer: "They address different private-market workflows. Harmonic focuses on early-stage startup discovery through founder and team signals. Grata is a private-market intelligence and dealmaking platform that Datasite acquired in 2025. Use Harmonic for early-stage venture sourcing, and Grata for broader private-company research and deal work." },
      { question: "How does Harmonic compare to Eilla AI?", answer: "They fit different parts of the deal workflow. Harmonic is a sourcing product for identifying startups. Eilla provides AI-supported research, buyer identification, deal materials, and due-diligence workflows for M&A, VC, and PE teams. Harmonic helps identify a candidate, while Eilla supports work around a transaction." },
      { question: "How does Harmonic compare to SourceScrub?", answer: "SourceScrub is an AI-driven deal sourcing platform for private-market research and deal origination. Harmonic focuses on early-stage startup discovery through founder and team patterns. The better fit depends on whether the team is sourcing broad private-company targets or early-stage venture opportunities." },
      { question: "How does Harmonic compare to Synaptic?", answer: "Synaptic is an alternative-data platform used for investment research, sourcing, tracking, and diligence. Harmonic focuses on startup sourcing through founder and team signals. Synaptic is the broader research layer, while Harmonic is closer to an early-stage candidate-discovery tool." },
    ],
