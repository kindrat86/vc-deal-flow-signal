...
{
  {
    const priceNeedles: Array<[string, string]> = [
      ...
      ["../app/walkthrough/page.tsx", "€49/mo, month to month, cancel anytime."],
      ["../app/book/thanks/page.tsx", "keep their €9.97/mo rate for life."],
      ["../app/funnels/page.tsx", "month to month, cancel anytime."],
      ["../app/origin/your-journey/page.tsx", "350+ ranked orgs, refreshed weekly, month to month,"],
      ["../app/llms.txt/route.ts", "€49/mo Dashboard, €197/mo Insider Circle"],
      ["../app/llms-full.txt/route.ts", "**Dashboard, €49/month**"],
      ["../app/.well-known/dpa.json/route.ts", "€197/mo"],
      ["../app/insider/page.tsx", "Insider Circle is €197/mo"],
      ["../app/thanks/dashboard/page.tsx", "Welcome to the Dashboard"],
      ["../app/thanks/insider/page.tsx", "Welcome to the Insider Circle"],
      ["../app/quiz/QuizForm.tsx", "€49/mo"],
      ["../app/launch/[slug]/page.tsx", "{!launch.isOpen && \" (window closed)\"}"],
      ["../lib/stripe.ts", "4900: \"dashboard\""],
      ["../lib/stripe.ts", "19700: \"insider\""],
      ["../content/launches.ts", "slug: \"founding-100\",\n    isOpen: false,"],
      ["../content/launches.ts", "slug: \"agent-credits\",\n    isOpen: false,"],
      ["../content/launches.ts", "slug: \"sector-sweep-2026-q2\",\n    isOpen: false,"],
      ["../components/LiveReplayBar.tsx", "that window is closed."],
      ["../components/FastActionBonuses.tsx", "that window is closed and is not coming back."],
    ];
    ...
    const priceBans: Array<[string, RegExp]> = [
      ...
      ["../app/llms.txt/route.ts", /€9\.97\/mo Dashboard Beta|€97\/mo Insider Circle/],
      ...
      ["../components/HomeOfferStack.tsx", /140 ranked/],
       ["../app/walkthrough/page.tsx", /€9\.97\/mo,|locked forever|founding-member rate|€119\.64|founding price/],
      ["../app/walkthrough/5min/page.tsx", /€9\.97|locked forever|€119\.64|founding-member rate/],
      ["../app/walkthrough/90s/page.tsx", /€119\.64|founder price/],
      ["../app/pitch/page.tsx", /€9\.97|locked forever|founder price/],
      ["../app/insider/page.tsx", /€1,164|locked forever|founding rate|€97\/mo founder|founding-member rate/],
      ["../app/firstlook/page.tsx", /€177|€1,797|€119\.64|founding rate|€2\.97/],
      ["../app/firstlook/downsell/page.tsx", /€1,797/],
      ["../app/funnels/page.tsx", /€9\.97|€97\/mo|€119\.64|€1,797|€177|founding price/],
      ["../app/origin/page.tsx", /€9\.97\/mo, forever|founding-price|founding price/],
      ["../app/origin/your-journey/page.tsx", /€9\.97|founding rate|locked forever|founding-rate Dashboard/],
      ["../app/start-here/page.tsx", /€9\.97|€97\/mo|locked forever/],
      ["../app/roadmap/page.tsx", /€9\.97|founding price|founding-member rate/],
      ["../app/state-of-github/page.tsx", /€97\/month|founding price/],
      ["../app/from/facebook/page.tsx", /€9\.97/],
      ["../app/quiz/QuizForm.tsx", /€9\.97\/mo, founder|€9\.97\/mo · |founding-member rate/],
      ["../app/welcome/page.tsx", /locked in forever|€9\.97|€97\/mo/],
      ["../app/thanks/firstlook/page.tsx", /€2\.97|€9\.97|founding rate/],
      ["../app/thanks/insider/page.tsx", /€97\/mo founder|locked forever/],
      ["../app/thanks/dashboard/page.tsx", /€9\.97\/mo, locked/],
      ["../app/alternatives/page.tsx", /€9\.97|€97\/mo Insider|Founding-member rates lock in/],
      ["../app/challenge/page.tsx", /€9\.97/],
      ["../app/challenge/done/page.tsx", /€9\.97|founding rate/],
      ["../app/code-side-sourcing/page.tsx", /€9\.97/],
      ["../app/use-cases/[slug]/page.tsx", /€9\.97/],
      ["../app/vsl/page.tsx", /€9\.97|Founding rate|founding rate/],
      ["../app/decade-in-a-day/page.tsx", /€119\.64|14×/],
      ["../app/llms-full.txt/route.ts", /€9\.97\/month\) \(founding-member rate;|€97\/month\) \(founding-member rate;|Founding-member rates lock in|Paid \(€9\.97\/mo Dashboard\)/],
      ["../app/api/scout/predict/route.ts", /EUR 9\.97\/mo/],
      ["../app/api/book/download/route.ts", /€9\.97/],
      ["../app/about/founder/page.tsx", /€9\.97|founding price is locked forever/],
      ["../app/page.tsx", /€9\.97|If the founding rate/],
      ["../app/.well-known/dpa.json/route.ts", /€97\/mo/],
      ["../components/HomeOfferStack.tsx", /€9\.97|locked forever|Founding-member rate/],
      ["../components/BuyerRoadmap.tsx", /€9\.97|€119\.64|founding rate locked/],
      ["../components/ThirtyDayQuickstart.tsx", /€119\.64|14×|founding rate locks/],
      ["../components/FalseBeliefBreaker.tsx", /€119\.64/],
      ["../components/RiskReversalPromise.tsx", /€97\/mo|Founding-rate ratchet/],
      ["../components/LiveReplayBar.tsx", /next cohort|doors close|Doors closing|countdown/],
      ["../components/FastActionBonuses.tsx", /€1,797|founding-member checkout|founding-rate ratchet|paused until Monday|last-hours/],
      ["../lib/soap-opera-scout.ts", /EUR 9\.97/],
      ["../lib/daily-seinfeld.ts", /€9\.97|€97\/mo founder/],
      ["../lib/firstlook-generator.ts", /€9\.97/],
      ["../lib/data-nerd.ts", /€9\.97\/mo is a feature|€9\.97\/mo and not|founding price is locked forever|locked at €97\/mo until/],
      ["../lib/emails.ts", /lock the founding rate|locked at the founding rate|founding rate stays locked|capped at 100 at the founding rate|€9\.97\/mo founding/],
      ["../lib/replay-window.ts", /€9\.97\/mo founding link/],
      ["../content/videos.ts", /nine ninety-seven|nine euros ninety-seven|one thousand six hundred twenty-eight|founding tier|founding cohort/],
      ["../content/competitor-teardowns.ts", /€9\.97|€1,797|€77\/mo/],
      ["../content/roadmap-board.ts", /€97\/mo subscribers/],
      ["../content/affiliate-swipe-kit.ts", /€9\.97/],
      ["../content/challenge-curriculum.ts", /founding rate \(€9\.97|founding-rate clock/],
      ["../content/state-of-engineering-velocity.ts", /97 EUR per month|locked forever for buyers/],
      ["../content/comparisons.ts", /EUR 9\.97/],
      ["../content/launches.ts", /€177|claim a founding spot|23 of 100 spots|Cohort opens now/],
      ["../content/summit.ts", /Founding-member is locked forever/],
      ["../content/vsl-script.json", /nine ninety-seven|€9\.97|founding rate, locked forever|Locked at the founding rate/],
    ];
