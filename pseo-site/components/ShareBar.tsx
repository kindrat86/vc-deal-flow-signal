  ...
  return (
    <div className="flex items-center gap-3 text-sm">
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 rounded-md border border-slate-700 bg-slate-800/50 px-3 py-1.5 text-xs text-gray-400 hover:text-sky-400 hover:border-sky-500/40 transition-colors"
      >
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-md border border-slate-700 bg-slate-800/50 px-3 py-1.5 text-xs text-gray-400 hover:text-sky-400 hover:border-sky-500/40 transition-colors cursor-pointer"
      >
        <svg
