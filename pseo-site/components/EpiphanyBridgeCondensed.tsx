...
const STEPS: readonly Step[] = [
  {
    ...
    color: "amber",
    title: "Backstory",
    body: "Ten years writing €5k–€50k angel cheques through warm intros — Athens, not San Francisco.",
  },
  {
    n: 2,
    color: "amber",
    title: "Desire",
    body: "Be the first investor in the room. Not the third one shown the deck.",
  },
  {
    n: 3,
    color: "rose",
    title: "External wall",
    body: "By the time a deck reached me through any warm intro, three other investors were already in.",
  },
  {
    n: 4,
    color: "rose",
    title: "Internal shift",
    body: "Stopped networking. Started reading commit graphs the way quants read SEC filings.",
  },
  {
    n: 5,
    color: "emerald",
    title: "New opportunity",
    body: "Code-side acceleration leads the deck by 21–47 days. The data is public. The lens was missing.",
  },
] as const;
